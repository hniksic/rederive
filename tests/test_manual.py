...
NOT_YET_HELD = {
    ...
    "test_probability_and_statistics[GAMMA(z)-(z - 1)!]",
    ...
    "test_the_algebra_of_declared_nonscalars[(a + b)`-a` + b`]",
    "test_the_algebra_of_declared_nonscalars[(a . b) . c-a . (b . c)]",
    "test_the_algebra_of_declared_nonscalars[(a . b)^-1-b^-1 . a^-1]",
    "test_the_algebra_of_declared_nonscalars[(a . b)`-b` . a`]",
    "test_the_algebra_of_declared_nonscalars[(a^-1)`-a`^-1]",
    "test_the_algebra_of_declared_nonscalars[(b + c) . a-b . a + c . a]",
